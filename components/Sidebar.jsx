...
const Sidebar = () => {
  ...
  useEffect(() => {
   // Client-side logic can go here, such as setting up event listeners
   // or handling state updates that are specific to the client
 }, []);
  ...
  const handleProjectsDropdownClick = () => {
  ...
  const handleCampaignsDropdownClick = () => {
    setCampaignsDropdown(!campaignsDropdown);
    setLeadsDropdown(false);
    setProjectsDropdown(false);
    setUsersDropdown(false);
  };
    ...
    <>
      ...
      >
         ...
         <button
          ...
          <div
            className="flex items-center px-0 ps-2.5 mb-5">
          ...
          <ul className="space-y-2 font-medium">
            ...
            <li className="dropdown">
              <button
                ...
                onClick={handleLeadsDropdownClick}
              >
                <svg
                ...
                </svg><span className="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">
                  Leads
                </span>
                <svg
                  className="w-3 h-3"
              ...
              <ul
                className={`dropdown-content py-2 space-y-2 ${
                  leadsDropdown ? "show" : "hidden"
                }`}
                id="dropdown-example"
              >
                <li>
            ...
            <li className="dropdown">
              <button
                ...
                aria-controls="dropdown-example"
                data-collapse-toggle="dropdown-example"
                onClick={handleProjectsDropdownClick}
              >
                <svg
                  className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                  aria-hidden="true"
            ...
            <li className="dropdown">
              <button
                ...
                aria-controls="dropdown-example"
                data-collapse-toggle="dropdown-example"
                onClick={handleCampaignsDropdownClick}
              >
                <svg
                  className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                  aria-hidden="true"
              ...
              <ul
                className={`dropdown-content py-2 space-y-2 ${
                  campaignsDropdown ? "show" : "hidden"
                }`}
                id="dropdown-example"
              >
                <li>
                  <a
                    href="/Campaigns/AllCampaigns"
                    className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                  >
                    Over-All Campaigns
                  </a>
                ...
                <li>
                  <a
                    href="/Campaigns/CreateCampaigns"
                    className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                  >
                    Add Campaign
                  </a>
            ...
            <li className="dropdown">
              <button
                ...
                aria-controls="dropdown-example"
                data-collapse-toggle="dropdown-example"
                onClick={handleUsersDropdownClick}
              >
                <svg
                  className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                  aria-hidden="true"
            ...
            <li>
              ...
              >
                <svg
                  className="flex-shrink-0 w-5 h-5 text-gray-500 transitionduration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  viewBox="0 0 18 20"
